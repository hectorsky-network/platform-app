...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <p class="text-muted"> {{env("APP_NAME")}}<sup>v1.4.4</sup> | Made with <a style="color:red;">♥</a> by <a href="https://github.com/hectorsky-network" target="_blank">Hectorsky Network</a><br>
