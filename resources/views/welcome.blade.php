            ...
            <div id="launcherCarousel" class="carousel slide launcher" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <img class="first-slide" src="{{ asset('images/launchers/modpacks.png') }}" alt="First Slide" style="">
                    </div>

                    <div class="item">
                        <img class="second-slide" src="{{ asset('images/launchers/options_pack.png') }}" alt="Second Slide">
                    </div>
